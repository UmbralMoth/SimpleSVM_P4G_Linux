...
if (CurrentDR3 == TargetDR3 && (CurrentDR7 & 0xF0000040) == 0x40)
            {
                if (leaf == 0x1)
                {
                    // Persona 4 Golden specific CPUID spoofing (AMD Ryzen 9 5900X)
                    GuestContext->VpRegs->Rax = 0x00A20F10;
                    GuestContext->VpRegs->Rbx = 0x00180800;
                    GuestContext->VpRegs->Rcx = 0x7AD8320B; // 0x7ED8320B for XGETBV support == 1 (bit 26)
                ...
                {
                    // "AMD Ryzen 9 5900X"
                    GuestContext->VpRegs->Rax = 0x20444D41;
                    GuestContext->VpRegs->Rbx = 0x657A7952;
                    GuestContext->VpRegs->Rcx = 0x2039206E;
                    GuestContext->VpRegs->Rdx = 0x30303935;
                ...
                {
                    // "21 X-Croper seco"
                    GuestContext->VpRegs->Rax = 0x32312058;
                    GuestContext->VpRegs->Rbx = 0x726F432D;
                    GuestContext->VpRegs->Rcx = 0x72502065;
                    GuestContext->VpRegs->Rdx = 0x7365636F;
                ...
                {
                    // " sro    "
                    GuestContext->VpRegs->Rax = 0x20726F73;
                    GuestContext->VpRegs->Rbx = 0x20202020;
                    GuestContext->VpRegs->Rcx = 0x20202020;
                    GuestContext->VpRegs->Rdx = 0x00202020;
